...
export default function HeaderEditorial({ userName, userEmail, onLogout, onBackToSelector, onShowLogs, onShowProfile, onSwitchDashboard, otherDashboardName, headerExpanded, setHeaderExpanded, hasActiveFilters }) {
